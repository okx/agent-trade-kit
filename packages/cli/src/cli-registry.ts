  ...
  account: {
    ...
    commands: {
      ...
      "balance-all": {
        ...
        usage: "okx account balance-all [<ccy>] [--accounts trading,funding] [--no-valuation] [--valuationCcy <ccy>]",
        description: "One-shot snapshot: trading + funding (+ valuation) in one call",
      },
      "asset-balance": {
