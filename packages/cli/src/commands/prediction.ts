...
function printPredictionHelp(): void {
  const lines = [
    ...
    "",
    "  ws prices/books/trades/tickers/event-status/game/candle1m/.../candle1D <assetId...>",
    "                                  Public WebSocket streams",
    "  ws orders/positions/balance/user-trades/pnl/private",
    "                                  Private WebSocket streams (HMAC)",
    "  ws terminal [assetId]           Full-screen TUI trading terminal",
    "",
