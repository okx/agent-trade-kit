...
import type { CdnChecksum, CdnSource, InstallResult, RemoveResult } from "../doh/installer-types.js";
import { getPlatformDir, hashFile, CDN_SOURCES, DOWNLOAD_TIMEOUT_MS } from "../doh/installer.js";
...
export const AUTH_CDN_PATH_PREFIX = "/upgradeapp/doh/prepub/oauth";
...
// ---------------------------------------------------------------------------
// HTTP utilities (duplicated from doh/installer.ts — same pattern)
// ---------------------------------------------------------------------------
