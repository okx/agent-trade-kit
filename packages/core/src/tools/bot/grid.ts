  ...
  return [
    {
      ...
      module: "bot.grid",
      description:
        "Query grid trading bot list. status='active' for running bots; status='history' for completed/stopped. Covers Spot Grid, Contract Grid, and Moon Grid.",
      isWrite: false,
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      module: "bot.grid",
      description:
        "Query details of a single grid trading bot by its algo ID. Returns configuration, current status, PnL, and position info.",
      isWrite: false,
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      module: "bot.grid",
      description:
        "Query individual sub-orders (grid trades) generated by a grid bot. type='filled' for executed trades; type='live' for pending orders.",
      isWrite: false,
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        ...
        "For spot: provide quoteSz or baseSz. For contract: provide direction, lever, and sz.",
      isWrite: true,
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        ...
        "For contract grids, stopType controls whether positions are closed ('1') or only orders cancelled ('2').",
      isWrite: true,
      inputSchema: {
        type: "object",
        properties: {
