...
| `@okx-trade/mcp` | `packages/mcp` | MCP server exposing ~155 tools over stdio (JSON-RPC 2.0) |
...
As of the latest registry scan, the server exposes **155 MCP tools** organized into **17 modules** (authoritative count: see `docs/module-registry.md`):
