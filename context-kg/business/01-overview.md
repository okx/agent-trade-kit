...
As of the latest registry scan, the server exposes **164 MCP tools** organized into **17 modules** (authoritative count: see `docs/module-registry.md`):
...
- `skills/okx-cex-auth/` — authentication and session management
