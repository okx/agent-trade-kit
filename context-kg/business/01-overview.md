...
| `@okx-trade/mcp` | `packages/mcp` | MCP server exposing ~148 tools over stdio (JSON-RPC 2.0) |
...
As of the latest registry scan, the server exposes **148 MCP tools** organized into **16 modules** (authoritative count: see `docs/module-registry.md`):
