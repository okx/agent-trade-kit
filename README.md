...
| `copytrading` | 5 | Copy trading: browse lead traders, follow/unfollow, monitor copy positions. SWAP only. **Not loaded by default** — enable with `--modules copytrading` or `--modules all`. | [→](docs/modules/copytrading.md) |
