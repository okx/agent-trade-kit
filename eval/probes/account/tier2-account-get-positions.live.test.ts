...
const USER_PROMPT = `Use the OKX CLI account_get_positions tool to list all my current open positions across all instrument types. Summarize the count and any key positions. Include "${EVAL_NONCE}" verbatim in your reply.`;
