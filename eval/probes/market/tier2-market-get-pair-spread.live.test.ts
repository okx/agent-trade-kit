// eval/probes/market/tier2-market-get-pair-spread.live.test.ts
...
const PROBE_ID = 'tier2.market-get-pair-spread';
const USER_PROMPT = 'Get the spread statistics between BTC-USDT-SWAP and ETH-USDT-SWAP over the last week using 15m bars. Just run the appropriate okx CLI command once. Skip auth checks.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "market", "pair-spread"]];
const EXPECTATION = 'okx market pair-spread';
