...
const USER_PROMPT = `Use the OKX CLI grid_get_orders tool to list my current grid trading bot orders. Report active bots and their status, or confirm there are none. Include "${EVAL_NONCE}" verbatim in your reply.`;
