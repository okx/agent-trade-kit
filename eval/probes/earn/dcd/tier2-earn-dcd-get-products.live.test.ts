...
const USER_PROMPT = 'List available Dual Currency Deposit (DCD) products for BTC-USDT. Show available strike prices or yields.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx earn", "dcd", "products"]];
const EXPECTATION = 'okx earn dcd products';
