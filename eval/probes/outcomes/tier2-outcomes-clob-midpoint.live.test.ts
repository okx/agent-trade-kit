// eval/probes/outcomes/tier2-outcomes-clob-midpoint.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-midpoint';
const USER_PROMPT = 'Get the midpoint price for prediction asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob midpoint command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "midpoint"]];
const EXPECTATION = 'okx outcomes clob midpoint';
