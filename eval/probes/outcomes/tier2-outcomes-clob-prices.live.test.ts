// eval/probes/outcomes/tier2-outcomes-clob-prices.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-prices';
const USER_PROMPT = 'Get current prices for prediction assets 100888000, 100888001, 100888002. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob prices command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "prices"]];
const EXPECTATION = 'okx outcomes clob prices';
