// eval/probes/outcomes/tier2-outcomes-clob-price.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-price';
const USER_PROMPT = 'Get the live prediction price for asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob price command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "price"]];
const EXPECTATION = 'okx outcomes clob price';
