// eval/probes/outcomes/tier2-outcomes-data-event-markets.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-event-markets';
const USER_PROMPT = 'List all markets for prediction event 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data event-markets command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "event-markets"]];
const EXPECTATION = 'okx outcomes data event-markets';
