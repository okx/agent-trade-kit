// eval/probes/outcomes/tier2-outcomes-data-events.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-events';
const USER_PROMPT = 'List prediction events. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data events command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "events"]];
const EXPECTATION = 'okx outcomes data events';
