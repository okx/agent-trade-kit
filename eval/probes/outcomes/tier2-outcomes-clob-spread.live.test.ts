// eval/probes/outcomes/tier2-outcomes-clob-spread.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-spread';
const USER_PROMPT = 'Get the bid-ask spread for prediction asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob spread command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "spread"]];
const EXPECTATION = 'okx outcomes clob spread';
