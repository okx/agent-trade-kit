// eval/probes/outcomes/tier2-outcomes-account-balance.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-account-balance';
const USER_PROMPT = 'Show my prediction market account balance. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes auth login. Just run the okx outcomes account balance command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "account", "balance"]];
const EXPECTATION = 'okx outcomes account balance';
