// eval/probes/outcomes/tier2-outcomes-data-candles-bar.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-candles-bar';
const USER_PROMPT = 'Show me 1H OHLCV candles for asset 100170100. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data candles --bar 1H command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "candles", "--bar", "1H"]];
const EXPECTATION = 'okx outcomes data candles --bar 1H';
