// eval/probes/outcomes/tier2-outcomes-clob-books.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-books';
const USER_PROMPT = 'Get order books for prediction assets 100888000, 100888001, 100888002. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob books command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "books"]];
const EXPECTATION = 'okx outcomes clob books';
