// eval/probes/outcomes/tier2-outcomes-account-trades.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-account-trades';
const USER_PROMPT = 'Show my prediction market trade history. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes auth login. Just run the okx outcomes account trades command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "account", "trades"]];
const EXPECTATION = 'okx outcomes account trades';
