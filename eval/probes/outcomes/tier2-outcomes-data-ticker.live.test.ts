// eval/probes/outcomes/tier2-outcomes-data-ticker.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-ticker';
const USER_PROMPT = 'Show me 24-hour ticker statistics for prediction asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data ticker command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "ticker"]];
const EXPECTATION = 'okx outcomes data ticker';
