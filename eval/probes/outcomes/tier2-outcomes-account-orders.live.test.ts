// eval/probes/outcomes/tier2-outcomes-account-orders.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-account-orders';
const USER_PROMPT = 'List my prediction market orders. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes auth login. Just run the okx outcomes account orders command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "account", "orders"]];
const EXPECTATION = 'okx outcomes account orders';
