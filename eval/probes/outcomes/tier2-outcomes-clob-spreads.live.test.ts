// eval/probes/outcomes/tier2-outcomes-clob-spreads.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-spreads';
const USER_PROMPT = 'Get bid-ask spreads for multiple prediction assets. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob spreads command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "spreads"]];
const EXPECTATION = 'okx outcomes clob spreads';
