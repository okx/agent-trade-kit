// eval/probes/outcomes/tier2-outcomes-clob-book-sz.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-book-sz';
const USER_PROMPT = 'Show top 20 levels of order book for asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob book --sz 20 command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "book", "--sz", "20"]];
const EXPECTATION = 'okx outcomes clob book --sz 20';
