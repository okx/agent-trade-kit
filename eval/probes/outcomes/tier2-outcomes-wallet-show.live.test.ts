// eval/probes/outcomes/tier2-outcomes-wallet-show.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-wallet-show';
const USER_PROMPT = 'Show the wallet address for the configured outcomes signing key. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes auth login. Just run the okx outcomes wallet show command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "wallet", "show"]];
const EXPECTATION = 'okx outcomes wallet show';
