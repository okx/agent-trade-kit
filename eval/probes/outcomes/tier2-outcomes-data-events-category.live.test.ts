// eval/probes/outcomes/tier2-outcomes-data-events-category.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-events-category';
const USER_PROMPT = 'List sports category prediction events. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data events --category command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "events", "--category", "sports"]];
const EXPECTATION = 'okx outcomes data events --category sports';
