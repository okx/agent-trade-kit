// eval/probes/outcomes/tier2-outcomes-data-market.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-market';
const USER_PROMPT = 'Get market info for prediction market mkt_t001. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data market command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "market"]];
const EXPECTATION = 'okx outcomes data market';
