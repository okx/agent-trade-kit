// eval/probes/outcomes/tier2-outcomes-data-candles.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-candles';
const USER_PROMPT = 'Show me OHLCV candle history for prediction asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data candles command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "candles"]];
const EXPECTATION = 'okx outcomes data candles';
