// eval/probes/outcomes/tier2-outcomes-account-positions.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-account-positions';
const USER_PROMPT = 'Show my open prediction positions. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes auth login. Just run the okx outcomes account positions command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "account", "positions"]];
const EXPECTATION = 'okx outcomes account positions';
