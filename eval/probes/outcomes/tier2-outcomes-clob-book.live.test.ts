// eval/probes/outcomes/tier2-outcomes-clob-book.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-clob-book';
const USER_PROMPT = 'Get the order book for prediction asset 100888000. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes clob book command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "clob", "book"]];
const EXPECTATION = 'okx outcomes clob book';
