// eval/probes/outcomes/tier2-outcomes-data-trending.live.test.ts
...
const PROBE_ID = 'tier2.outcomes-data-trending';
const USER_PROMPT = 'Show trending prediction events. Skip any auth check — assume credentials are configured. Do NOT run okx auth login or okx outcomes setup. Just run the okx outcomes data trending command once.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx", "outcomes", "data", "trending"]];
const EXPECTATION = 'okx outcomes data trending';
