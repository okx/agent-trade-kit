...
const USER_PROMPT = `Use the OKX CLI news_get_latest tool to fetch the 3 most recent crypto news headlines. List the titles. Include "${EVAL_NONCE}" verbatim in your reply.`;
