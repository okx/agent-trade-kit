...
const USER_PROMPT = `Use the OKX CLI news_get_coin_sentiment tool to get the current bullish/bearish sentiment for BTC over the last 24 hours. Report the sentiment label (bullish/bearish/neutral/mixed), bullish ratio, and total mention count. Include "${EVAL_NONCE}" verbatim in your reply.`;
