...
const USER_PROMPT = 'Place a limit buy order for 1 contract of BTC-USD-250926 (quarterly futures) at price 1 in demo/dry-run mode.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx futures", "place", "BTC-USD-250926"]];
const EXPECTATION = 'okx futures place BTC-USD-250926';
