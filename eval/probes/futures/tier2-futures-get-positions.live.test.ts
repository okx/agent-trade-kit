...
const USER_PROMPT = `Use the OKX CLI futures_get_positions tool to check my current futures positions. Report any open positions or confirm there are none. Include "${EVAL_NONCE}" verbatim in your reply.`;
