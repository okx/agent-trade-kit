...
const USER_PROMPT = 'Check my current futures positions. Report any open positions or confirm there are none.';
const EXPECTED_COMMAND_PATTERNS: string[][] = [["okx futures", "positions"], ["okx", "account", "positions", "FUTURES"]];
const EXPECTATION = 'okx futures positions / account positions --instType FUTURES';
