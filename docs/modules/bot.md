...
| `bot.dca` | 5 | Spot DCA (Martingale) strategies |
...
| `dca_get_sub_orders` | List sub-orders / cycles generated by a DCA strategy |
...
| `dca_get_sub_orders` | 列出 DCA 策略生成的子订单 / 周期 |
...
**DCA：**
- "创建 BTC 现货 DCA 机器人：初始 50 USDT，安全单 30 USDT，最多 3 个，5% 间距，3% 止盈，20% 止损"
- "显示我的 DCA 策略"
